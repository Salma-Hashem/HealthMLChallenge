...
Writes append-only JSONL entries to logs/audit.jsonl.
No raw PHI reaches the log: patient IDs are SHA-256 hashed and booking
...
# Write to logs/ directory at the project root (two levels up from safety/).
