...
departments for the next 14 days, respecting office hours and using a
deterministic hash to mark ~80% of slots as available.
"""
...
from models import Department, Provider, Slot
